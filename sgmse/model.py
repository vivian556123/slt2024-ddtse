...
class ScoreModel(pl.LightningModule):
    ...
    def add_argparse_args(parser):
        ...
        parser.add_argument("--loss_type", type=str, default="mse", choices=("mse", "mae","l1","l2"), help="The type of loss function to use.")
        parser.add_argument("--sisdr", type=float, default=-1.0,  help="The weight of sisdr loss")
        parser.add_argument("--triplet", type=float, default=-1.0,  help="The weight of triplet loss")
        ...
        parser.add_argument("--deepspeed_optimizer", action='store_true',   help="Use a speaker encoder (train simultaneously with the model) instead of pretrained SV net")
        parser.add_argument("--TF_version2", action='store_true',     help="teacher forcing and max threshold")
        parser.add_argument("--valid_rir", action='store_true',     help="teacher forcing and max threshold")
